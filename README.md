...
The data set for testing the 9 formulations E1B1, E1B2, E1B4, E2B1, E2B2, E2B4, E3B1, E3B2, E3B4 on 1080 Markov Graphs is included in the pkl file Markov_graph_data.pkl
